...
$repo = "ember-mesh-gossip-gate"
$language = "SQL"
$category = "Distributed systems"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/ember-mesh-gossip-walkthrough.md")) {
