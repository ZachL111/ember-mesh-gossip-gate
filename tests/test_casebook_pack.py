"""Regression checks for the ember-mesh-gossip-gate casebook."""
...
from casebook.harness import assert_expected, ember_mesh_gossip_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ember_mesh_gossip_gate_summary(), assert_expected())
